// ===================================================
// rain_bday.js — Birthday Countdown + Rain Effect
// Modified from original rain.js for Birthday Theme
// ===================================================
...
function startFireworks() {
    ...
    // Show "next" button after 10s of fireworks
...
// ===================================================
// CORE ENGINE (S namespace — same as original)
// ===================================================
var S = {
    init: function () {
        ...
        // ===== BIRTHDAY SEQUENCE =====
        S.UI.simulate(
            "#countdown 3|LINH THÚI 🎂|PÉ THÚI ❤️|CHÚC PÉ IU|MẪU ĂN CHÓNG LỚN|TUỔI MỚI NHIỀU MONEY 💵|HAPPY BIRTHDAY 🎂❤️"
        );
        ...
        timedAction(function (index) {
            ...
            switch (action) {
                    ...
                    timedAction(function (index) {
                        if (index === 0) {
                            if (sequence.length === 0) {
                                ...
                                setTimeout(function () { startFireworks(); }, 1500);
                            } else {
                ...
                case 'time':
                    ...
                    break;
                default:
                    S.Shape.switchShape(S.ShapeBuilder.letter(current[0] === cmd ? 'Happy Birthday' : current));
            }
...
S.ShapeBuilder = (function () {
    ...
    return {
        imageFile: function (url, callback) {
            ...
            image.onerror = function () { callback(S.ShapeBuilder.letter('HBD!')); };
            image.src = url;
        },
        circle: function (d) {
...
// ===== BIRTHDAY RAIN LETTERS =====
const letters  = 'HAPPY BIRTHDAY LINH THUI 07102004 LOVE PÉ THÚI'.split('');
const fontSize = 20;
